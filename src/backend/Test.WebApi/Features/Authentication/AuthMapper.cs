using Test.Application.Features.Authentication.Dtos;
using Test.WebApi.Features.Authentication.Dtos.ChangePassword;
using Test.WebApi.Features.Authentication.Dtos.External;
using Test.WebApi.Features.Authentication.Dtos.Login;
using Test.WebApi.Features.Authentication.Dtos.Register;
using Test.WebApi.Features.Authentication.Dtos.ResetPassword;
using Test.WebApi.Features.Authentication.Dtos.SetPassword;
using Test.WebApi.Features.Authentication.Dtos.TwoFactor;
using Test.WebApi.Features.Authentication.Dtos.VerifyEmail;

namespace Test.WebApi.Features.Authentication;
