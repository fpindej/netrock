...
///   <item><c>Authorization: Test roles=Superuser permissions=*</c> - wildcard claim grants every permission</item>
/// </list>
/// </para>
/// </summary>
...
internal static class TestAuth
{
    ...
    public static string Superuser() => $"Test roles={AppRoles.Superuser} permissions={AppPermissions.Wildcard}";
