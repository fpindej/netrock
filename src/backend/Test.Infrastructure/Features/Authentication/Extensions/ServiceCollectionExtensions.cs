...
using Test.Application.Cryptography;
...
using Test.Infrastructure.Features.Authentication.Services;
using Test.Infrastructure.Features.Authentication.Services.ExternalProviders;

namespace Test.Infrastructure.Features.Authentication.Extensions;
