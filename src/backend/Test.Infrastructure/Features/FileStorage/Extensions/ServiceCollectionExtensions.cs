...
using Test.Infrastructure.Features.FileStorage.Options;
using Test.Infrastructure.Features.FileStorage.Services;

namespace Test.Infrastructure.Features.FileStorage.Extensions;
